export const diseases = {
    ...
    leaf_blast: {
        vi: "Đạo ôn",
        data: [
            "* Là một trong những bệnh gây thiệt hại lớn nhất cho nông nghiệp toàn thế giới.",
            "* Lúc đầu vết bệnh chỉ nhỏ như đầu mũi kim, màu xám xanh giống như bị nước sôi, sau chuyển sang màu nâu, rồi lan rộng dần ra thành hình thoi (hình mắt én) xung quanh màu nâu đậm, giữa màu xám trắng.",
            "* Nếu nặng, nhiều vết liên kết lại với nhau tạo thành mảng lớn, có thể làm lá bị khô cháy, cây lúa lụi tàn, gây thất thu năng suất nghiêm trọng.",
    ...
    healthy: {
        vi: "Khỏe mạnh",
        data: [
            "* Lúa khỏe mạnh, không có dấu hiệu của bất kỳ bệnh hại nào.",
            "* Lá lúa màu xanh tươi, không có vết nứt, đốm nâu hoặc dấu hiệu của bất kỳ tổn thương nào.",
            "* Cây lúa phát triển đồng đều, có màu sắc và hình dáng phù hợp.",
            "* Khả năng sinh sản và sản xuất hạt của lúa được duy trì ở mức cao.",
            "* Đảm bảo việc cung cấp đủ nước và dinh dưỡng cho cây lúa."
        ]
    }
}